<?php 
    ...
    /* Tämä header on aktiivinen templatessa alasivuilla! + Etusivulla */
?>
						...
						<div class="row">
							<div class="col-xl-8 col-lg-12">
								<div class="row">
                                    ...
                                    <div class="col-md-6 red"><i class="fa fa-map-marker margin-right-10px"></i>
                                        <?php //echo esc_html($niletheme_option['location']); ?>
                                        <a href="/gde-kupit/">Где купить?</a>

                                        <a href="#search" style="float: right;"><i class="fa fa-search margin-right-10px" style="color: #333;"></i></a>
                                    </div>
								</div>
							</div>
					...
					<div class="position-relative">
                        ...
                        ?>
                            ...
                            <?php 
                                ...
                                //$link = "/jalleenmyyjille/";
                            ?>

                            <!--
							<?php if($niletheme_option['niletheme-header-quoteLink'] == '1'){ ?>
							<div class="col-lg-1 col-md-12 ">
								<a href="<?php echo $link; ?>" class="btn btn-sm border-radius-30 margin-tb-20px text-white  background-main-color  box-shadow float-lg-right padding-lr-20px d-block">
...
<div id="search">
	...
	<form id="searchform" role="search" method="get" class="search-form clearfix d-block" action="<?php echo esc_url( home_url( '/' ) ); ?>">
		<input type="search" class="search-field" placeholder="<?php esc_attr_e ( 'Ключевое слово', 'nilelogistics' ) ?>" value="" name="s" title="<?php esc_attr_e( 'Search for:', 'nilelogistics' ) ?>" required>
		<input type="submit" class="search-submit btn btn-primary" value="<?php esc_attr_e( 'Найти', 'nilelogistics' ) ?>" />
	</form>
</div>
<!-- // Search  -->
