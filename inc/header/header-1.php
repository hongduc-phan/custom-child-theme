<?php 
    ...
    if($niletheme_option['niletheme-header-quoteLink'] == '1'){
        $menu_class="col-lg-8 col-md-12";
    }else{
        $menu_class="col-lg-9 col-md-12";
    }

    /* Tämä header ei ole aktiivisessa käytössä enää! */
?>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-md-6"><i class="fa fa-map-marker margin-right-10px"></i>
                                    <?php echo esc_html($niletheme_option['location']); ?>
                                    <a href="#search" style="float: right;"><i class="fa fa-search margin-right-10px" style="color: #fff;"></i></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="position-relative">
                    <div class="row">
                        ...
                        <div class="col-lg-1 col-md-12  d-none d-lg-block">
                            <a href="<?php echo $link; ?>" class="btn btn-sm border-radius-30 margin-tb-20px text-white  background-main-color  box-shadow float-right padding-lr-20px margin-left-30px d-block">
